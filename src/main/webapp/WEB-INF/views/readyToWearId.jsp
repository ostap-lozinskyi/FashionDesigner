...
<div class="container">
    <div class="row">
        <div class="col-md-1 text-center portraitHidden">
            <a class="arrow" href="/readyToWear/${previousModel}"><img src="/resources/img/arrowLeft.png"
                                                                       style="width: 100px;"></a>
        </div>
            ...
            <div id="carouselExampleIndicators" class="carousel" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="photoID" data-toggle="modal" data-target="#exampleModalCenter"
                             src="${clothingModel.photoUrls[0]}?version=${clothingModel.version}" alt="First slide">
                    </div>
                    <c:forEach var="photoUrl" items="${clothingModel.photoUrls}" begin="1">
                        <div class="carousel-item">
                            <img class="photoID" data-toggle="modal" data-target="#exampleModalCenter"
                                 src="${photoUrl}?version=${clothingModel.version}" alt="...">
                        </div>
                    </c:forEach>
                </div>
        ...
        <div class="col-md-1 text-center portraitHidden">
            <a class="arrow" href="/readyToWear/${nextModel}">
                <img src="/resources/img/arrowRight.png" style="width: 100px;">
            </a>
        </div>
        <div class="col-lg-4 idText portraitHidden">
            <p>${clothingModel.text}</p>
            <div class="col-12 text-center">
                <a class="headerItem" href="/contacts" target="_blank">
    ...
    <div class="row landscapeHidden">
        <div class="col-6 text-center">
            <a class="arrow" href="/hauteCouture/${previousModel}">
                <img src="/resources/img/arrowLeft.png" style="width: 100px;">
            </a>
        </div>
        <div class="col-6 text-center">
            <a class="arrow" href="/hauteCouture/${nextModel}">
                <img src="/resources/img/arrowRight.png" style="width: 100px;">
            </a>
        </div>
    </div>
    <div class="row">
        <div class="col-12 text-center">
            <img data-target="#carouselExampleIndicators" data-slide-to="0" class="photoIDmini active"
                 src="${clothingModel.photoUrls[0]}?version=${clothingModel.version}">
            <c:set var="count" value="1" scope="page"/>
            <c:forEach var="photoUrl" items="${clothingModel.photoUrls}" begin="1">
                <img data-target="#carouselExampleIndicators" data-slide-to="${count}" class="photoIDmini"
                     src="${photoUrl}?version=${clothingModel.version}">
