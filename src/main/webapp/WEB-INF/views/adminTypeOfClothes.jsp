		...
		<div class="row">			
			<div class="col-12">
                <div class="row">
                    <div class="col-12">
                        <h3>Add new Type</h3>
                        <form:form action="/admin/adminTypeOfClothes" method="POST" modelAttribute="typeOfClothes">
                            ...
                            <div class="form-group row">
                                <div class="col-8 mr-auto">
                                    ...
                                    <a href="/admin/adminTypeOfClothes/cancel<custom:allParams/>" class="btn btn-sm btn-outline-warning">Cancel</a>
                                </div>
                            </div>
                        </form:form>
                    </div>
		        ...
		        <div class="row">			
                    ...
                    <div class="col-2">
                        <custom:size posibleSizes="1,2,5,10" size="${showTypesOfClothes.size}" />
                    </div>			
		        </div>
		        <br>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-bordered">
                            ...
                            <c:if test="${empty showTypesOfClothes.content}">
                                <tr>
                                <td colspan=7><h3 class="text-center">Types with such parameters not found</h3></td>
                                </tr>
                            </c:if>
                            <c:forEach var="showTypeOfClothes" items="${showTypesOfClothes.content}">
                                <tr>
                                    <td>${showTypeOfClothes.name}</td>                                    
                                    <td class="text-center">                                       
                                        <a href="/admin/adminTypeOfClothes/update/${showTypeOfClothes.id}<custom:allParams/>"	class="btn btn-outline-warning btn-sm margin">Update</a>
                                        <a href="/admin/adminTypeOfClothes/delete/${showTypeOfClothes.id}<custom:allParams/>"	class="btn btn-outline-danger btn-sm margin">Delete</a>
                                    </td>                                    
                                </tr>
                            </c:forEach>
                        </table>
                ...
                <div class="row">
                    <div class="col-12">
                        <custom:pageable page="${showTypesOfClothes}"/>
                    </div>
                </div>		    
			</div>
		</div>
