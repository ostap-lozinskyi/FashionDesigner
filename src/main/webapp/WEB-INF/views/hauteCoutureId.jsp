...
<div class="container">
    <div class="row">
        <div class="col-md-1 text-center portraitHidden">
            <a class="arrow" href="/hauteCouture/${previousModel}"><img src="/resources/img/arrowLeft.png"
                                                                        style="width: 100px;"></a>
        </div>
        ...
        <div class="col-md-1 text-center portraitHidden">
            <a class="arrow" href="/hauteCouture/${nextModel}"><img src="/resources/img/arrowRight.png"
                                                                    style="width: 100px;"></a>
        </div>
