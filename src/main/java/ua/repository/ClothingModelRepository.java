...
public interface ClothingModelRepository extends JpaNameRepository<ClothingModel>,
        JpaSpecificationExecutor<ClothingModel> {
    ...
    @Query("SELECT new ua.model.view.ClothingModelView(cm.id, cm.name, cm.text, season.name, type.name, section.name, cm.version)"
