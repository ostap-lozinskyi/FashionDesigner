		...
		<div class="row">
			<div class="col-lg-2 col-sm-12">				
				<div class="btn-group-vertical text-center" role="group" aria-label="Basic example">
					...
					<a class="btn btn-success" href="/admin/adminIngredient">Ingredients</a>
                            ...
                            <c:forEach var="ingredient" items="${ingredients.content}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/adminIngredient/update/${ingredient.id}<custom:allParams/>" class="btn btn-outline-warning btn-sm margin">Update</a>
                                        <a href="/admin/adminIngredient/delete/${ingredient.id}<custom:allParams/>" class="btn btn-outline-danger btn-sm margin">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
